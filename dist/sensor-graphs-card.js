 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $=globalThis,w=t=>t,A=$.trustedTypes,E=A?A.createPolicy("lit-html",{createHTML:t=>t}):void 0,S="$lit$",k=`lit$${Math.random().toFixed(9).slice(2)}$`,C="?"+k,T=`<${C}>`,P=document,M=()=>P.createComment(""),z=t=>null===t||"object"!=typeof t&&"function"!=typeof t,U=Array.isArray,D="[ \t\n\f\r]",R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,H=/-->/g,O=/>/g,N=RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),L=/'/g,I=/"/g,F=/^(?:script|style|textarea|title)$/i,j=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),B=j(1),V=j(2),q=Symbol.for("lit-noChange"),G=Symbol.for("lit-nothing"),W=new WeakMap,K=P.createTreeWalker(P,129);function J(t,e){if(!U(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==E?E.createHTML(e):e}const Z=(t,e)=>{const s=t.length-1,i=[];let o,r=2===e?"<svg>":3===e?"<math>":"",n=R;for(let e=0;e<s;e++){const s=t[e];let a,l,c=-1,h=0;for(;h<s.length&&(n.lastIndex=h,l=n.exec(s),null!==l);)h=n.lastIndex,n===R?"!--"===l[1]?n=H:void 0!==l[1]?n=O:void 0!==l[2]?(F.test(l[2])&&(o=RegExp("</"+l[2],"g")),n=N):void 0!==l[3]&&(n=N):n===N?">"===l[0]?(n=o??R,c=-1):void 0===l[1]?c=-2:(c=n.lastIndex-l[2].length,a=l[1],n=void 0===l[3]?N:'"'===l[3]?I:L):n===I||n===L?n=N:n===H||n===O?n=R:(n=N,o=void 0);const d=n===N&&t[e+1].startsWith("/>")?" ":"";r+=n===R?s+T:c>=0?(i.push(a),s.slice(0,c)+S+s.slice(c)+k+d):s+k+(-2===c?e:d)}return[J(t,r+(t[s]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),i]};class X{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let o=0,r=0;const n=t.length-1,a=this.parts,[l,c]=Z(t,e);if(this.el=X.createElement(l,s),K.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(i=K.nextNode())&&a.length<n;){if(1===i.nodeType){if(i.hasAttributes())for(const t of i.getAttributeNames())if(t.endsWith(S)){const e=c[r++],s=i.getAttribute(t).split(k),n=/([.?@])?(.*)/.exec(e);a.push({type:1,index:o,name:n[2],strings:s,ctor:"."===n[1]?st:"?"===n[1]?it:"@"===n[1]?ot:et}),i.removeAttribute(t)}else t.startsWith(k)&&(a.push({type:6,index:o}),i.removeAttribute(t));if(F.test(i.tagName)){const t=i.textContent.split(k),e=t.length-1;if(e>0){i.textContent=A?A.emptyScript:"";for(let s=0;s<e;s++)i.append(t[s],M()),K.nextNode(),a.push({type:2,index:++o});i.append(t[e],M())}}}else if(8===i.nodeType)if(i.data===C)a.push({type:2,index:o});else{let t=-1;for(;-1!==(t=i.data.indexOf(k,t+1));)a.push({type:7,index:o}),t+=k.length-1}o++}}static createElement(t,e){const s=P.createElement("template");return s.innerHTML=t,s}}function Y(t,e,s=t,i){if(e===q)return e;let o=void 0!==i?s._$Co?.[i]:s._$Cl;const r=z(e)?void 0:e._$litDirective$;return o?.constructor!==r&&(o?._$AO?.(!1),void 0===r?o=void 0:(o=new r(t),o._$AT(t,s,i)),void 0!==i?(s._$Co??=[])[i]=o:s._$Cl=o),void 0!==o&&(e=Y(t,o._$AS(t,e.values),o,i)),e}class Q{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??P).importNode(e,!0);K.currentNode=i;let o=K.nextNode(),r=0,n=0,a=s[0];for(;void 0!==a;){if(r===a.index){let e;2===a.type?e=new tt(o,o.nextSibling,this,t):1===a.type?e=new a.ctor(o,a.name,a.strings,this,t):6===a.type&&(e=new rt(o,this,t)),this._$AV.push(e),a=s[++n]}r!==a?.index&&(o=K.nextNode(),r++)}return K.currentNode=P,i}p(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class tt{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=G,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Y(this,t,e),z(t)?t===G||null==t||""===t?(this._$AH!==G&&this._$AR(),this._$AH=G):t!==this._$AH&&t!==q&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>U(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==G&&z(this._$AH)?this._$AA.nextSibling.data=t:this.T(P.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:s}=t,i="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=X.createElement(J(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{const t=new Q(i,this),s=t.u(this.options);t.p(e),this.T(s),this._$AH=t}}_$AC(t){let e=W.get(t.strings);return void 0===e&&W.set(t.strings,e=new X(t)),e}k(t){U(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const o of t)i===e.length?e.push(s=new tt(this.O(M()),this.O(M()),this,this.options)):s=e[i],s._$AI(o),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=w(t).nextSibling;w(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class et{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,o){this.type=1,this._$AH=G,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=G}_$AI(t,e=this,s,i){const o=this.strings;let r=!1;if(void 0===o)t=Y(this,t,e,0),r=!z(t)||t!==this._$AH&&t!==q,r&&(this._$AH=t);else{const i=t;let n,a;for(t=o[0],n=0;n<o.length-1;n++)a=Y(this,i[s+n],e,n),a===q&&(a=this._$AH[n]),r||=!z(a)||a!==this._$AH[n],a===G?t=G:t!==G&&(t+=(a??"")+o[n+1]),this._$AH[n]=a}r&&!i&&this.j(t)}j(t){t===G?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class st extends et{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===G?void 0:t}}class it extends et{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==G)}}class ot extends et{constructor(t,e,s,i,o){super(t,e,s,i,o),this.type=5}_$AI(t,e=this){if((t=Y(this,t,e,0)??G)===q)return;const s=this._$AH,i=t===G&&s!==G||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==G&&(s===G||i);i&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class rt{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){Y(this,t)}}const nt=$.litHtmlPolyfillSupport;nt?.(X,tt),($.litHtmlVersions??=[]).push("3.3.2");const at=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;const ut=1e3,gt=200,ft=10,mt=8,_t=10,vt=8,xt=[.25,.5,.75].map(t=>(ft+t*(gt-ft-_t)).toFixed(1)),bt=new Set(["unavailable","unknown","none"]);function yt(t){if(!t||t.length<2)return null;if(t=function(t,e=3e5){if(!t?.length)return t;const s=[];let i=Math.floor(t[0].time.getTime()/e)*e,o=0,r=0;for(const n of t){const t=n.time.getTime();t>=i+e&&(r>0&&s.push({time:new Date(i),value:o/r}),i=Math.floor(t/e)*e,o=0,r=0),o+=n.value,r++}return r>0&&s.push({time:new Date(i),value:o/r}),s}(t,3e5),t.length<2)return null;const e=t.reduce((t,e)=>e.value<t?e.value:t,t[0].value),s=t.reduce((t,e)=>e.value>t?e.value:t,t[0].value),i=s-e,o=Math.max(.1*i,.5),r=e-o,n=s+o,a=t[0].time.getTime(),l=t[t.length-1].time.getTime()-a||1,c=t=>vt+(t-a)/l*(ut-vt-mt),h=t=>gt-_t-(t-r)/(n-r)*(gt-ft-_t),d=function(t,e=200){if(t.length<=e)return t;const s=Math.ceil(t.length/e);return t.filter((e,i)=>i%s===0||i===t.length-1)}(t,200),p=d.map(t=>({x:c(t.time.getTime()),y:h(t.value)})),u=function(t){if(t.length<2)return"";let e=`M ${t[0].x.toFixed(1)},${t[0].y.toFixed(1)}`;const s=1/8;for(let i=1;i<t.length;i++){const o=t[i-2]||t[i-1],r=t[i-1],n=t[i],a=t[i+1]||n;e+=` C ${(r.x+(n.x-o.x)*s).toFixed(1)},${(r.y+(n.y-o.y)*s).toFixed(1)} ${(n.x-(a.x-r.x)*s).toFixed(1)},${(n.y-(a.y-r.y)*s).toFixed(1)} ${n.x.toFixed(1)},${n.y.toFixed(1)}`}return e}(p),g=(gt-_t).toFixed(1),f=`${u} L ${p[p.length-1].x.toFixed(1)},${g} L ${p[0].x.toFixed(1)},${g} Z`,m=[0,Math.floor((t.length-1)/2),t.length-1].map(e=>t[e].time),_=i<1?2:1;return{linePath:u,areaPath:f,points:p,plotData:d,displayMin:e.toFixed(_),displayMax:s.toFixed(_),xTimes:m}}customElements.define("sensor-graph",class extends lt{static styles=dt;static properties={entityId:{type:String},label:{type:String},unit:{type:String},color:{type:String},data:{type:Array},currentValue:{type:String},hoverTime:{type:Object,hasChanged:()=>!0},_hoverIndex:{state:!0}};constructor(){super(),this.data=[],this.color="var(--primary-color)",this.hoverTime=null,this._hoverIndex=-1,this._paths=null}willUpdate(t){t.has("data")&&(this._paths=yt(this.data))}_toSvgCoords(t){const e=this.shadowRoot?.querySelector("svg");if(!e)return null;const s=e.getScreenCTM();if(!s)return null;const i=e.createSVGPoint();return i.x=t.clientX,i.y=t.clientY,i.matrixTransform(s.inverse())}_handleMouseMove(t){const e=this._paths;if(!e)return;const s=this._toSvgCoords(t);if(!s)return;let i=0,o=Math.abs(e.points[0].x-s.x);for(let t=1;t<e.points.length;t++){const r=Math.abs(e.points[t].x-s.x);r<o&&(o=r,i=t)}this._hoverIndex!==i&&(this._hoverIndex=i,this.dispatchEvent(new CustomEvent("sgc-hover",{detail:{time:this._paths.plotData[i].time},bubbles:!0,composed:!0})))}_handleMouseLeave(){this._hoverIndex=-1,this.dispatchEvent(new CustomEvent("sgc-hover-end",{bubbles:!0,composed:!0}))}_formatTooltipTime(t){return t.toLocaleString("de-DE",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"})}_formatXTime(t){return t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}_gradientId(){return`sgc-grad-${(this.entityId||"unknown").replace(/[^a-zA-Z0-9]/g,"-")}`}render(){const t=this._paths,e=this._gradientId(),s=this._hoverIndex>=0?this._hoverIndex:function(t,e){if(!t?.length||!e)return-1;const s=e.getTime();let i=0,o=Math.abs(t[0].time.getTime()-s);for(let e=1;e<t.length;e++){const r=Math.abs(t[e].time.getTime()-s);r<o&&(o=r,i=e)}return i}(t?.plotData??[],this.hoverTime),i=this._hoverIndex>=0,o=s>=0&&t?.plotData[s]?t.plotData[s]:null,r=o&&t?t.points[s]:null,n=r?r.x/ut*100:0,a=r?r.y/gt*100:0,l=n>72?`right:${(100-n+2).toFixed(1)}%`:`left:${(n+2).toFixed(1)}%`,c=`top:${a.toFixed(1)}%`,h=this.currentValue&&!bt.has(this.currentValue.toLowerCase()),d=o?`${o.value.toFixed(2)}${this.unit?" "+this.unit:""}`:h?`${this.currentValue}${this.unit?" "+this.unit:""}`:"–";return B`
    ...
    `}});const At=[{label:"1h",hours:1},{label:"6h",hours:6},{label:"12h",hours:12},{label:"24h",hours:24},{label:"7d",hours:168}];customElements.define("sensor-graphs-card",class extends lt{static styles=ht;static properties={_config:{state:!0},_historyData:{state:!0},_activeRange:{state:!0},_hoverTime:{state:!0}};constructor(){super(),this._historyData={},this._activeRange=At[1],this._hoverTime=null,this._lastLoad=0,this._loadId=0,this._loadTimer=null,this._hass=null}setConfig(t){if(!t)throw new Error("[sensor-graphs-card] setConfig called without config");const e=(this._config?.sensors||[]).map(t=>t.entity).join(","),s=(t.sensors||[]).map(t=>t.entity).join(",");this._config=t,e!==s&&(this._lastLoad=0,this._hass&&this._loadData())}set hass(t){this._hass=t,this._scheduleDataLoad(),this.requestUpdate()}getCardSize(){const t=this._config?.sensors?.length||3;return Math.max(3,2*t)}getLayoutOptions(){return{grid_rows:4,grid_columns:4,grid_min_rows:3,grid_max_rows:12,grid_min_columns:2,grid_max_columns:12}}static getConfigElement(){return document.createElement("sensor-graphs-card-editor")}static getStubConfig(){return{title:"Grow Tent",sensors:[{entity:"sensor.schedule_4_real_cb_temperature",color:"#03a9f4",label:"Temperatur"},{entity:"sensor.schedule_4_real_cb_humidity",color:"#4caf50",label:"Luftfeuchtigkeit"},{entity:"sensor.schedule_4_real_cb_vpd",color:"#ffb300",label:"VPD"},{entity:"sensor.schedule_4_real_cb_ppfd",color:"#e91e63",label:"PPFD"},{entity:"sensor.schedule_4_real_cb_co2",color:"#9c27b0",label:"CO2"}]}}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this._loadTimer)}_scheduleDataLoad(){Date.now()-this._lastLoad<6e4||(clearTimeout(this._loadTimer),this._loadTimer=setTimeout(()=>this._loadData(),100))}async _loadData(){if(!this._hass||!this._config?.sensors?.length)return;this._lastLoad=Date.now();const t=++this._loadId,e={};await Promise.all(this._config.sensors.filter(t=>t.entity).map(async t=>{e[t.entity]=await pt(this._hass,t.entity,this._activeRange.hours)})),t===this._loadId&&(this._historyData=e)}_selectRange(t){this._activeRange=t,this._lastLoad=0,this._loadData()}_onHover(t){this._hoverTime=t.detail.time}_onHoverEnd(){this._hoverTime=null}render(){if(!this._config)return B`
      ...
      <ha-card>
        ...
        <div class="graphs-container">
          ${0===t.length?B`<div class="empty">Keine Sensoren konfiguriert</div>`:t.filter(t=>(this._historyData[t.entity]?.length??0)>0).map(t=>{const e=this._hass?.states?.[t.entity];return B`
                    <sensor-graph
                      .entityId=${t.entity}
